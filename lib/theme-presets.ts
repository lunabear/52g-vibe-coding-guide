export const THEME_PRESETS = [
  {
    id: 'designSystem',
    name: '52g',
    description: '52g brand colors',
    recommendation: 'Trustworthy blue fits perfectly with the 52g brand palette',
    styleDescription: 'Official 52g brand design system',
    colorUsageRules: '- Brand color: **{primaryHex}(Blue)** must be used for main elements\n- Accent color: **{accentHex}(Orange)** for highlights',
    implementationGuideline: 'Implement a business-focused design that values trust and professionalism. Use a clean and intuitive layout, and apply a moderate corner radius (rounded-lg) to buttons and cards. Provide a professional interaction with smooth transitions (transition-all duration-300) and subtle shadow changes on hover. Prioritize readability in typography and ensure clear information hierarchy.',
    hexPalette: `:root {\n  --primary-100:#1493FF;\n  --primary-200:#58B2FF;\n  --primary-300:#BFE2FF;\n  --accent-100:#FF7A33;\n  --accent-200:#A3A3A3;\n  --text-100:#0B0B0B;\n  --text-200:#5D5D5D;\n  --bg-100:#F4F7FB;\n  --bg-200:#ECF2F9;\n  --bg-300:#DCE7F5;\n}`,
  ...
  },
  {
    id: 'modern-purple',
    name: 'MISO Purple',
    description: 'MISO brand colors',
    recommendation: 'Great when you want a creative and innovative feel',
    styleDescription: 'Modern and creative purple theme',
    colorUsageRules: '- Main elements: **Use {primaryHex}(Purple)**\n- Hover state: **Use {primary200Hex}(Light Purple)**\n- Background emphasis: **Use {accentHex}(Very Light Purple)**',
    implementationGuideline: 'Emphasize creativity and innovation with a modern design. Leverage gradients and soft shadows to highlight the mysterious and creative feel of purple. Use rounded-xl corners for friendly buttons and cards, and provide interactive experiences with color changes and slight scale effects on hover. Aim for a futuristic and inspirational atmosphere overall.',
    hexPalette: `:root {\n  --primary-100:#5542F6;\n  --primary-200:#8B7CF6;\n  --primary-300:#D2D6FF;\n  --accent-100:#E6E9FF;\n  --accent-200:#A3A3A3;\n  --text-100:#111111;\n  --text-200:#5D5D5D;\n  --bg-100:#F7FAFF;\n  --bg-200:#F1F5FF;\n  --bg-300:#E6ECFF;\n}`,
  ...
  },
  {
    ...
    recommendation: 'A perfect choice for business presentations',
    styleDescription: 'Trustworthy professional blue theme',
    colorUsageRules: '- Main elements: **Use {primaryHex}(Blue)** consistently\n- Hover/Active: **Use {primary200Hex}(Light Blue)**\n- Background separation: **Use {accentHex}(Very Light Blue)**',
    implementationGuideline: 'Communicate stability and reliability with a professional design. Use a clear structure with consistent padding/margins for a tidy feel. Buttons should have rounded-lg corners with solid shadows to communicate clickability. On hover, strengthen shadows rather than colors for stable feedback. Create an enterprise-grade trustworthy atmosphere overall.',
    hexPalette: `:root {\n  --primary-100:#2AA8FF;\n  --primary-200:#74C8FF;\n  --primary-300:#C8E9FF;\n  --accent-100:#E8F1FA;\n  --accent-200:#A3A3A3;\n  --text-100:#0B0B0B;\n  --text-200:#5D5D5D;\n  --bg-100:#F5FAFE;\n  --bg-200:#EDF5FB;\n  --bg-300:#E3EFF8;\n}`,
  ...
  },
  {
    id: 'chic-black',
    name: 'Chic Black',
    description: 'Clean black theme',
    recommendation: 'Recommended for a clean, refined minimal design',
    styleDescription: 'Minimal and refined black theme',
    colorUsageRules: '- Primary button: **{primaryHex}(Black) background, white text**\n- Outline button: **Transparent background, {primaryHex}(Black) border & text**\n- Accent: **{accentHex}(Blue)** as highlight',
    implementationGuideline: 'Follow minimalism by removing unnecessary elements. Create clear hierarchy using strong black/white contrast with generous spacing. Keep shadows minimal, and on hover use subtle color/opacity changes for a premium interaction. Keep typography clean and readable, reflecting Scandinavian restraint overall.',
    hexPalette: `:root {\n  --primary-100:#000000;\n  --primary-200:#222222;\n  --primary-300:#555555;\n  --accent-100:#3BA3FF;\n  --accent-200:#A3A3A3;\n  --text-100:#000000;\n  --text-200:#CCCCCC;\n  --bg-100:#FAFAFA;\n  --bg-200:#F2F2F2;\n  --bg-300:#E6E6E6;\n}`,
  ...
  },
  {
    ...
    recommendation: 'Perfect for a premium UI with refined glassmorphism',
    styleDescription: 'Glassmorphism - delicate transparency with soft blur',
    colorUsageRules: '- Main elements: **{primaryHex}(Soft Blue)** with subtle transparency\n- Glass effect: **Precise backdrop-blur and gradients** required\n- Accent: **{accentHex}(Lavender)** as elegant highlight\n- Apply **Apple-grade glass texture** across elements',
    implementationGuideline: 'Follow Apple’s refined glassmorphism language. Apply transparency (e.g., backdrop-blur-xl, bg-white/80) to cards and modals, using subtle gradients and inner shadows to achieve glass texture. Use large radii (rounded-2xl) and soft shadows for floating buttons, and adjust transparency/blur on hover for depth. Aim for a premium yet warm interface.',
    hexPalette: `:root {
  --primary-100:#007AFF;
  --primary-200:#5AC8FA;
  --primary-300:#BFE7FF;
